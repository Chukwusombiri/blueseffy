<div class="relative inline-flex items-center px-1 transition border-b-2 border-transparent hover:border-indigo-400"
    x-data="{ open: false }" @click.away="open = false" @close.stop="open = false">    
        ...
        type="button" class="w-full flex items-center gap-1 text-xs archivo-600 uppercase dark:text-gray-100" id="menu-button"
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        class="absolute top-full -left-[50%] z-20 mt-2 w-56 divide-y divide-gray-100 border border-gray-300 rounded-md bg-white shadow-xl overflow-hidden dark:bg-gray-700 dark:text-gray-100 dark:divide-gray-600"
