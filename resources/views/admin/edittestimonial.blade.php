            ...
            <form method="POST" action="{{route('admin.testimonials.update',[$testimonial->id])}}" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control @error('testifier') is-invalid @enderror" id="testifier" name="testifier" value="{{old('testifier') ?? $testimonial->testifier}}" required>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('testifier_job') is-invalid @enderror" id="testifier_job" name="testifier_job" value="{{old('testifier_job') ?? $testimonial->testifier_job}}" required>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <textarea rows="4" type="text" class="form-control @error('testimony') is-invalid @enderror" id="testimony" name="testimony" value="{{old('testimony') ?? $testimonial->testimony}}" required ></textarea>
