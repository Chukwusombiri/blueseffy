...
<section class="py-[70px]"  id="contact-header">
  <div class="mx-auto px-4 sm:container">
     <div class="border-stroke border-b stats-link">
        <h2 class="mb-2 text-2xl font-semibold text-white capitalize">
           We are always available
        </h2>
        <p class="text-white mb-6 text-sm font-medium">
           Our dedicated and passionate support team are always online. 24/7 services. Talk to us now and we will respond to you with solutions.
        </p>
     </div>
  </div>
</section>
      ...
      <div class="-mx-4 flex flex-wrap lg:justify-between">
        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div class="mb-12 max-w-[570px] lg:mb-0">
            <span class="text-indigo-600 mb-4 block text-base font-semibold">
              Contact Us
            </span>
            <h2
            ...
            <p class="text-body-color mb-9 text-base leading-relaxed">
              Here, at {{$company->name}}, our members and their needs is our top priority. We've setup the latest technologies needed to enhance communication and support
              systems. We are available 24/7 and always eager to talk to you. Contact us now and get solutions to any challenge instantly. We won't disappoint you. 
            </p>
            <div class="mb-8 flex w-full max-w-[370px]">
              <div
                class="bg-indigo-600 text-indigo-600 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
              >
                <svg
                  width="24"
                  height="24"
            ...
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">{{$company->tel}}</p>
              </div>
            </div>
            <div class="mb-8 flex w-full max-w-[370px]">
              <div
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">{{$company->email}}</p>
              </div>
            </div>
          </div>
        </div>
