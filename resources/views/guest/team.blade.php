        ...
        <div class="mycontainer mx-auto">
                ...
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
                        ...
                        <p class="text-body-color text-base">
                            We aim to keep our members informed and knowledgeabe when it comes to matters of the
                            financial markets. Read through this articles and so many
                        ...
                        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                            <div class="mx-auto mb-10 max-w-[370px]">
                                <div class="mb-8 overflow-hidden rounded">
                                    <img src="{{ url('storage/' . $article->cover_img) }}" alt="image"
                                        class="w-full" />
                                </div>
                                <div>
                                    <span
            ...
            <div class="flex justify-center py-10">
                <a href="{{ route('articles') }}"
                    class="bg-indigo-600 mb-5 inline-block rounded py-1 
      px-4 text-center text-xs font-semibold leading-loose text-white">View
                    all</a>
            </div>
        </div>
    </section>
