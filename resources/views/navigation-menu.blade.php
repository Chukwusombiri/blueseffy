        ...
        <div class="flex justify-between h-16 items-center">
                ...
                @guest
                    <div class="ml-3 relative">
                        <x-secondary-link-button href="{{ route('login') }}">
                            <span class="mr-1">{{ __('Sign in') }}</span>
            ...
            <div class="flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-700 dark:text-gray-200 hover:text-gray-800 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray700 transition">
