<div class="card">
  <div class="card-header">
    ...
    <div class="card-tools">
      <div class="input-group input-group-sm" style="width: 300px;">
        ...
        placeholder="filter by name or amount or wallet" wire:model="search">
        @if ($search!=='')
  ...
  <div class="card-body table-responsive">
    <div class="input-group input-group-sm mb-3" style="width: max-content;">
      <a href="{{route('admin.withdrawal.create')}}" class="btn btn-block btn-primary btn-sm">create new</a>
    </div>
           ...
           @if (count($withdrawals)>0)
              @foreach ($withdrawals as $withdrawal)
               <tr>                  
                   ...
                   <td class="d-flex">
                     @if ($withdrawal->is_approved)
                       <a wire:click='$emit("openModal","admin.edit-withdrawal",@json([$withdrawal->id]))'
