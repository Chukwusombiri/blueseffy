<div>
    <div class="container py-4">
        <div>
            <h2 class="md:text-lg ml-4 text-dark-700 text-center">create referral income for member</h2>
        </div>
        ...
        <div class="w-3/4 mx-auto mb-2">
            ...
            <input type="number" name="amount" id="amount" wire:model.defer="amount" class="form-control px-2 py-2 rounded-lg">
            @error('amount')
                <span class="inline-block bg-red-100 mt-2 p-2">{{$message}}</span> 
            @enderror
        </div>                       
