<div class="mycontainer">
    <div class="mb-20">
        <span class="flex flex-nowrap justify-center item-center text-base text-indigo-600 uppercase text-extrabold mb-7">Make Deposit</span>
        <h2 class="text-center text-dark text-2xl capitalize mb-4 mx-auto md:w-1/2">Fill out your account funding form below.</h2>
        <p class="text-center mx-auto text-slate-600 md:w-1/2"> BLUESTECH accepts only cryptocurrency as a source of payment for account funding. 
